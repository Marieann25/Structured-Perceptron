...
public class FeatureFactory {
	...
	List<String> features = new ArrayList<String>();
	  ...
	  prevposition = 0;
        ...
        //features.add("previscaptilized=" + previscaptilized + ", iscaptilized=" + iscaptilized  + ", nextiscaptilized=" + nextiscaptilized);
        features.add("pervWord=" + previousWord + ", prevLabel=" + previousLabel);
